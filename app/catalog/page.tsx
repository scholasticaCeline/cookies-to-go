      ...
      <section className="bg-zinc-950 text-white py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-zinc-400 text-xl max-w-2xl font-medium text-center md:text-left">
            ...
            Every <span className="text-white font-bold">Individual cookies</span> are priced at <span className="text-white font-bold">12.000</span>.  <span className="text-white font-bold">Two cookies</span> are priced at <span className="text-white font-bold">20.000.</span>
          </p>
        </div>
      </section>
